...
From the Heisenberg equation of motion we know (also see pfaffian paper)
...
\begin{align}
	\mathrm{Tr}\left\{ \gamma_{m}\gamma_{j}\boldsymbol{U}_{\pi(1)}...\boldsymbol{U}_{\pi(N)}   \right\} = W\left[ \phi \right]  \left[\frac{\left(\mathbb{I} - \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right) }{ \left(\mathbb{I} + \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right)  }\right]_{mj}  = W\left[ \phi \right] \left[2\left(\mathbb{I} + \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right)^{-1}   - \mathbb{I}\right]_{mj} ,
\end{align}
which is the greens function for this particular operator string. By using this we find

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right] \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right]_{im}  \left[2\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \right)^{-1}   - \mathbb{I}\right] _{mj} \nonumber \\
	&= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right]  \underbrace{\left[ 2 \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}\left(\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \right)^{-1}   - \mathbb{I}\right)\right]_{mj}}_{:= \boldsymbol{C} _{mj} }  \nonumber \\
\end{align}
...
\begin{align}
	\boldsymbol{C} &= \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}\left(2\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2 \left(\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{2N_\tau} \right)\boldsymbol{B}_{2N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1}         \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{2N_\tau} \right)^{-1} \boldsymbol{B}_{2N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1} - \mathbb{I}\right) \nonumber \\
	&= \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{2N_\tau} \boldsymbol{M} ^{-1}  \boldsymbol{B}_{2N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1} - \mathbb{I}\right) \nonumber \\
	& = \boldsymbol{B}_{1}...\boldsymbol{B}_{2N_{\tau} }2\boldsymbol{M^{-1}}\boldsymbol{B}_{2N_\tau}^{-1} ...\boldsymbol{B}_{2l+1}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
	&= 2\boldsymbol{M}^{-1}\boldsymbol{B}_{1}...\boldsymbol{B}_{2N_\tau} \boldsymbol{B}_{2N_\tau}^{-1} ...\boldsymbol{B}_{2l+1}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
	&= 2\boldsymbol{M^{-1}}\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} - \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
	&= \left(2\boldsymbol{M}^{-1} - \mathbb{I}\right)\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
	&= \boldsymbol{G}\boldsymbol{B}_{1}...\boldsymbol{B}_{2l}     
\end{align}
Here we used that $\left[ \boldsymbol{M}, \boldsymbol{B}_{1}...\boldsymbol{B}_{2N_\tau}   \right] = 0 $. The correlator is then given by

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[\phi\right] \left[\boldsymbol{G}\boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right]_{ij} 
\end{align}
...
\begin{align}
	...
	&= \mathrm{Re} \left(\frac{\mathrm{d} }{\mathrm{d}\phi_{x}^{t} }  S_B[\phi] \right) + 2\mathrm{Re}\left(  \xi  \left(\left[\mathcal{B}\left(k+1\right)M^{-1} \mathcal{A}\left(k\right)\right]_{2,1} - \left[\mathcal{B}\left(k+1\right)M^{-1} \mathcal{A}\left(k\right)_{1,2}\right]  \right)_{x,x}  \right)
\end{align}
