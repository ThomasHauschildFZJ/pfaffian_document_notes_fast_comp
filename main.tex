...
\begin{align}
	...
	&\approx Z^{-1} \mathrm{Tr}\left\{ \gamma_{i}\left[\prod_{t=1}^{l-1} e^{-\Delta_\tau \boldsymbol{H_{0} } }e^{-\Delta_\tau \boldsymbol{H_{1} }}\right]\gamma_{j}\left[\prod_{t=l}^{N_{\tau} } e^{-\Delta_\tau \boldsymbol{H_{0} } }e^{-\Delta_\tau \boldsymbol{H_{1} }}\right]   \right\}. 
\end{align}

Here we substituted the Heisenberg picture operators, and used the cyclic property of traces. In the last step we used a Suzuki Trotter decomposition of second order (not third like in the improved correlator). We also defined $N_{\tau} = \frac{\beta}{\Delta_{\tau}} $ and $l = \frac{\beta - \tau}{\Delta_{\tau} } $. Next we perform the now familiar Hubbard Stratanovic transformation. 

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)  e^{-S_{B} } \mathrm{Tr}\left\{ \gamma_{i}\underbrace{e^{-\frac{1}{4}\boldsymbol{\gamma}^{\mathrm{T}} \boldsymbol{A_{1}\boldsymbol{\gamma} } }}_{:=\boldsymbol{U} _{1} }  ... e^{-\frac{1}{4}\boldsymbol{\gamma}^{\mathrm{T}} \boldsymbol{A_{l-1}\boldsymbol{\gamma} } } \gamma_{j} e^{-\frac{1}{4}\boldsymbol{\gamma}^{\mathrm{T}} \boldsymbol{A_{l}\boldsymbol{\gamma} } }...e^{-\frac{1}{4}\boldsymbol{\gamma}^{\mathrm{T}} \boldsymbol{A_{N_{\tau} }\boldsymbol{\gamma} } }    \right\} 
\end{align} 
...
\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}  \right]_{im} \mathrm{Tr}\left\{ \boldsymbol{U}_{1}...\boldsymbol{U}_{l-1}\gamma_{m}\gamma_{j}\boldsymbol{U}_{l}...\boldsymbol{U}_{N_{\tau} }   \right\} \nonumber \\
	&=    Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}  \right]_{im} \mathrm{Tr}\left\{ \gamma_{m}\gamma_{j}\boldsymbol{U}_{l}...\boldsymbol{U}_{N_{\tau} }\boldsymbol{U}_{1}...\boldsymbol{U}_{l-1}   \right\} \nonumber \\
\end{align}

In appendix XXX (ADD THIS, it is also in paper but without derivation) we show

\begin{align}
	\mathrm{Tr}\left\{ \gamma_{m}\gamma_{j}\boldsymbol{U}_{\pi(1)}...\boldsymbol{U}_{\pi(N)}   \right\} = W\left[ \phi \right]  \left[\frac{\left(\mathbb{I} - \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right) }{ \left(\mathbb{I} + \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right)^{-1}  }\right]_{mj}  = W\left[ \phi \right] \left[2\left(\mathbb{I} + \boldsymbol{B}_{\pi(1)}...\boldsymbol{B}_{\pi(N)}\right)^{-1}   - \mathbb{I}\right]_{mj} ,
\end{align}
which is the greens function for this particular operator string. By using this we find

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right] \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}  \right]_{im}  \left[2\left(\mathbb{I} + \boldsymbol{B}_{l}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \right)^{-1}   - \mathbb{I}\right] _{mj} \nonumber \\
	&= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right]  \underbrace{\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} 2\left(\mathbb{I} + \boldsymbol{B}_{l}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \right)^{-1}   - \mathbb{I}\right]_{mj}}_{:= \boldsymbol{C} _{mj} }  \nonumber \\
\end{align}
...
\begin{align}
	\boldsymbol{C} &= \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}\left(2\left(\mathbb{I} + \boldsymbol{B}_{l}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}  \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \left(2 \left(\boldsymbol{B}_{l}...\boldsymbol{B}_{N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \right)\boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_l^{-1}         \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \left(2\boldsymbol{B}_{l}...\boldsymbol{B}_{N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \right)^{-1} \boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_l^{-1} - \mathbb{I}\right) \nonumber \\
	&= \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \left(2\boldsymbol{B}_{l}...\boldsymbol{B}_{N_\tau} \boldsymbol{M} ^{-1}  \boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_l^{-1} - \mathbb{I}\right) \nonumber \\
	& = \boldsymbol{B}_{1}...\boldsymbol{B}_{N_{\tau} }2\boldsymbol{M^{-1}}\boldsymbol{B}_{N_\tau}^{-1} ...\boldsymbol{B}_{l}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \nonumber \\
	&= 2\boldsymbol{M}^{-1}\boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \boldsymbol{B}_{N_\tau}^{-1} ...\boldsymbol{B}_{l}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \nonumber \\
	&= 2\boldsymbol{M^{-1}}\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} - \boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \nonumber \\
	&= \left(2\boldsymbol{M}^{-1} - \mathbb{I}\right)\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1} \nonumber \\
	&= \boldsymbol{G}\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}     
\end{align}
Therefore the the correlator is given by

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[\phi\right] \left[\boldsymbol{G}\boldsymbol{B}_{1}...\boldsymbol{B}_{l-1}  \right]_{ij} 
\end{align}
