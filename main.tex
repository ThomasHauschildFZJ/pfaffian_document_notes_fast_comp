...
\begin{align}
	\eta_{2t}&= \mathrm{Pf} \left(\begin{bmatrix}
	...
	\end{bmatrix} \right) = \mathrm{Pf} \left(\begin{bmatrix}
...
\begin{align}
	\eta_{2t} &= \mathrm{Pf} \left(\bigoplus_{i=1}^{N} \begin{bmatrix}
		0 & \sqrt 2 s_i & -1 & 0 \\
		-\sqrt 2 s_i & 0 & 0 & -1 \\
		+1 & 0 & 0 & \sqrt 2 s_i \\
		0 & +1 & -\sqrt 2 s_i & 0
	\end{bmatrix} \right)  = \prod_{i= 1}^{N} \mathrm{Pf} \left( \begin{bmatrix}
	0 & \sqrt 2 s_i & -1 & 0 \\
	-\sqrt 2 s_i & 0 & 0 & -1 \\
	+1 & 0 & 0 & \sqrt 2 s_i \\
	0 & +1 & -\sqrt 2 s_i & 0
	\end{bmatrix} \right)  \\&= \prod_{i=1}^{N}\left(2\mathrm{sin}^{2}  \left(\frac{1}{2}\xi \phi^{t}_i\right) - 1\right) 
	= \prod_{i=1}^{N} \left(-1\right) \mathrm{cos} \left(\xi \phi_i^{t} \right) ,
\end{align}
