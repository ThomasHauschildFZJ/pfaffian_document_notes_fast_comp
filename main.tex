...
\end{align}
Applying this identity to move the two Majorana singe particle operator next to one another one finds

\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right]_{im} \mathrm{Tr}\left\{ \boldsymbol{U}_{1}...\boldsymbol{U}_{2l}\gamma_{m}\gamma_{j}\boldsymbol{U}_{2l+1}...\boldsymbol{U}_{N_{\tau} }   \right\} \nonumber \\
	&=    Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right]_{im} \mathrm{Tr}\left\{ \gamma_{m}\gamma_{j}\boldsymbol{U}_{2l+1}...\boldsymbol{U}_{N_{\tau} }\boldsymbol{U}_{1}...\boldsymbol{U}_{2l}   \right\} \nonumber \\
\end{align}
...
\begin{align}
	\left< \gamma_{i}(\tau) \gamma_j(0)\right> &= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right] \sum_{m}^{ }\left[ \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right]_{im}  \left[2\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \right)^{-1}   - \mathbb{I}\right] _{mj} \nonumber \\
	&= Z^{-1}\int_{ }^{ } \mathrm{D}\left(\phi\right)e^{-S_{B}} W\left[ \phi \right]  \underbrace{\left[ 2 \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \right)^{-1}   - \mathbb{I}\right]_{mj}}_{:= \boldsymbol{C} _{mj} }  \nonumber \\
\end{align}
...
\begin{align}
	\boldsymbol{C} &= \boldsymbol{B}_{1}...\boldsymbol{B}_{2l}\left(2\left(\mathbb{I} + \boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_{\tau} }\boldsymbol{B}_{1}...\boldsymbol{B}_{2l}  \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2 \left(\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \right)\boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1}         \right)^{-1} - \mathbb{I}\right) \nonumber \\
	&=    \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_\tau}\left(\mathbb{I} + \boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \right)^{-1} \boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1} - \mathbb{I}\right) \nonumber \\
	&= \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \left(2\boldsymbol{B}_{2l+1}...\boldsymbol{B}_{N_\tau} \boldsymbol{M} ^{-1}  \boldsymbol{B}_{N_\tau}^{-1}...\boldsymbol{B}_{2l+1}^{-1} - \mathbb{I}\right) \nonumber \\
	& = \boldsymbol{B}_{1}...\boldsymbol{B}_{N_{\tau} }2\boldsymbol{M^{-1}}\boldsymbol{B}_{N_\tau}^{-1} ...\boldsymbol{B}_{2l+1}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
	&= 2\boldsymbol{M}^{-1}\boldsymbol{B}_{1}...\boldsymbol{B}_{N_\tau} \boldsymbol{B}_{N_\tau}^{-1} ...\boldsymbol{B}_{2l+1}^{-1} -   \boldsymbol{B}_{1}...\boldsymbol{B}_{2l} \nonumber \\
